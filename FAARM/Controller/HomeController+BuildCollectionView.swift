...
extension HomeController {
    ...
    // This functions tells us to use HomeHeaderCell as the cell for the header
    ...
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, referenceSizeForHeaderInSection section: Int) -> CGSize {
        ...
        var headerHeight = view.safeAreaLayoutGuide.layoutFrame.height - bodyHeight
        
        let model = UIDevice.current.model
        
        if (model != "iPhone" && model != "iPod"){
            headerHeight = headerHeight + headerHeight * 0.3
        }
    ...
    // This function tells the collection view to use our HomeBodyCell as the cells for this collection
    ...
    // This functions tells the collection view how big to make our cells
    func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
        let squareWidth = view.frame.width / 3
        var squareHeight = view.frame.width / 3
        
        let model = UIDevice.current.model
        
        if (model != "iPhone" && model != "iPod"){
            squareHeight = squareHeight * 0.7
        }
        
        return CGSize(width: squareWidth, height: squareHeight)
    }
    
    // This functions tells the collection view how many cells to make
    ...
    // Spacing Functions - We call these so that theres no extra spacing that we dont want, so we return 0
