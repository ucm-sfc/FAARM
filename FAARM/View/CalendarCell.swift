...
class CalendarCell: UITableViewCell {
    ...
    private func setupUI() {
        ...
        goldBottomDividerView.anchor(top: topAnchor, paddingTop: 0, left: leftAnchor, paddingLeft: 0, bottom: nil, paddingBotton: 0, right: rightAnchor, paddingRight: 0, width: 0, height: 2)
        
        addSubview(titleLabel)
        let offsetPadding = frame.width * 0.33
        titleLabel.anchor(top: goldBottomDividerView.topAnchor, paddingTop: 0, left: leftAnchor, paddingLeft: offsetPadding, bottom: bottomAnchor, paddingBotton: 0, right: rightAnchor, paddingRight: 10, width: 0, height: 0)
